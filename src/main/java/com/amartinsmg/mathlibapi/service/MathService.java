...
public class MathService {
    ...
    @ApiFunction(name = "triangle-area-2",
            namespace = "area-shape",
    ...
    @ApiFunction(name = "triangle-area-3",
            namespace = "area-shape",
    ...
    @ApiFunction(name = "parallelogram-area-2",
            namespace = "area-shape",
    ...
    @ApiFunction(name = "trapezoid-area",
            namespace = "area-shape",
    ...
    @ApiFunction(name = "regular-polygon-area",
            namespace = "area-shape",
    ...
    @ApiFunction(name = "circular-sector-area-2",
            namespace = "area-shape",
    ...
    @ApiFunction(name = "regular-prism-area",
            namespace = "area-surface",
    ...
    @ApiFunction(name = "regular-pyramid-area",
            namespace = "area-surface",
    ...
    @ApiFunction(name = "cylinder-area",
            namespace = "area-surface",
    ...
    @ApiFunction(name = "distance-points",
            namespace = "geometry",
    ...
    @ApiFunction(name = "inclination-line",
            namespace = "geometry",
            description = "Calculates the inclination angle of a line")
    ...
    @ApiFunction(name = "line-y-intercept",
            namespace = "geometry",
            description = "Calculates the y-intercept of a line")
    ...
    @ApiFunction(name = "distance-point-line",
            namespace = "geometry",
            description = "Calculates the distance from a point to a line")
    ...
    @ApiFunction(name = "simple-growth",
            namespace = "finance",
            description = "Calculates simple growth")
    ...
    @ApiFunction(name = "simple-growth-rate",
            namespace = "finance",
            description = "Calculates the simple growth rate")
    ...
    @ApiFunction(name = "compound-growth",
            namespace = "finance",
            description = "Calculates compound growth")
    ...
    @ApiFunction(name = "compound-growth-rate",
            namespace = "finance",
            description = "Calculates the compound growth rate")
    ...
    @ApiFunction(name = "prime-factors",
            namespace = "number-theory",
    ...
    @ApiFunction(name = "geometric-mean",
            namespace = "statistics",
    ...
    @ApiFunction(name = "harmonic-mean",
            namespace = "statistics",
    ...
    @ApiFunction(name = "midrange",
            namespace = "statistics",
            description = "Calculates the midrange of a dataset")
    public static double midrange(@ApiParam(name = "dataset") double[] arr) {
        return MathLibWrapper.midrange(arr);
    }

    @ApiFunction(name = "variance",
            namespace = "statistics",
    ...
    @ApiFunction(name = "side-right-triangle",
            namespace = "trigonometry",
    ...
    @ApiFunction(name = "side-triangle-law-of-cos",
            namespace = "trigonometry",
    ...
    @ApiFunction(name = "ang-triangle-law-of-cos",
            namespace = "trigonometry",
    ...
    @ApiFunction(name = "side-triangle-law-of-sin",
            namespace = "trigonometry",
    ...
    @ApiFunction(name = "ang-triangle-law-of-sin",
            namespace = "trigonometry",
    ...
    @ApiFunction(name = "regular-prism-volume",
            namespace = "volume",
    ...
    @ApiFunction(name = "pyramid-volume",
            namespace = "volume",
    ...
    @ApiFunction(name = "regular-pyramid-volume",
            namespace = "volume",
    ...
    @ApiFunction(name = "cylinder-volume",
            namespace = "volume",
